// [UPDATED] 2026-03-14 20:54 - Footer: logo real ALLERGOMED + redes sociales FB e IG
  ...
  return (
    <footer className="bg-[#0D1117] pt-1 pb-12">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        {/* ── Fila principal: logo izquierda, contacto derecha ── */}
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-12">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p
              className="text-sm text-[#6B7280] ml-[56px]"
            ...
            <div className="flex items-center gap-4 ml-[56px] mt-2">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/profile.php?id=61563906933060"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#6B7280] hover:text-[#00B4D8] transition-colors duration-200"
          ...
          <div
            className="flex flex-col items-start md:items-end gap-1 text-sm text-[#6B7280]"
            style={{ fontFamily: 'DM Sans, sans-serif' }}
          >
            <a
